...
findObstructions[F_, vars_, kinAssumptions_, kinVars_, maxSize_ : Automatic,
 ...
 Module[{factorData, safeFactors, factorsByDerivative, appearsIn,
  ...
  generatorConstructionAudit = If[ValueQ[$HRFLastCandidateGeneratorConstructionAudit],
    $HRFLastCandidateGeneratorConstructionAudit, <||>];
  ...
  limitReachedQ = (IntegerQ[genLimit] && genLimit < Infinity &&
      Length[generatorSets] >= genLimit) ||
    TrueQ[Lookup[generatorConstructionAudit, "CandidateGeneratorSetLimitReachedQ", False]];
  searchTruncatedQ = Or[
    limitReachedQ,
