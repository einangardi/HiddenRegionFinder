...
compactAudit[row_Association] := Join[
  ...
  <|
    ...
    "TotalScalingAudit" -> KeyTake[Lookup[row, "TotalScalingAudit", <||>], {
      ...
      "FSLOnLeadingFacetQ", "ResolvedFSLWeight",
      "FSLSubleadingAfterCancellationQ", "LeadingFacetRequiresFSLQ",
      "SourceAwareCertifiedRegionCount",
      "MultipleSourceAwareCertifiedRegionsQ",
      "SourceAwareSearchTruncatedQ", "SourceAwareSearchCompleteQ",
      "CertificationUnresolvedQ",
      "SyntheticFSLPromotionFacetQ",
      "SyntheticFSLPromotionUsedForAcceptanceQ",
      "IdealLayerCertification", "SourceAwareDissectionCertification",
