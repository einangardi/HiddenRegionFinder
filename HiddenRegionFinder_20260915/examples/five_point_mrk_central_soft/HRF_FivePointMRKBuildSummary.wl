...
summary = <|
  ...
  "TopologyCriterionObserved" ->
    "Every accepted ordering attaches p4 to internal vertex 3 or 5, but this endpoint condition is necessary rather than sufficient: ordering {1,3,2,5,4} is negative within this 12-ordering two-loop seed scan",
  "OrderRows" -> orderRows,
