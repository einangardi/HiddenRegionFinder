...
hrfEx02StudyRow[diagram_, configuration_, channel_, zeroVars_, activeVars_, scan_, U_, scaling_: Automatic, maxAbs_: 5] := Module[
  ...
  Join[row, <|
    ...
    "All-in-ideal decomposition?" -> If[ValueQ[hrfExactReductionQ], hrfExactReductionQ[scan], False],
...
hrfEx02ComparisonRow[diagram_, regionLabel_, zeroVars_, wideRow_, reggeRow_, boundaryRow_: <||>] := Module[
  ...
  <|
    ...
    "Wide all-in-ideal?" -> Lookup[wideRow, "All-in-ideal decomposition?", False],
    "Regge all-in-ideal?" -> Lookup[reggeRow, "All-in-ideal decomposition?", False],
...
hrfEx02BoundaryChannelDetailRow[boundaryRow_Association, channel_String] := Module[
  ...
  <|
    ...
    "All-in-ideal decomposition?" -> Lookup[study, "All-in-ideal decomposition?",
      Lookup[chMeta, "AllInIdealDecompositionQ", Lookup[chMeta, "ExactReductionQ", False]]],
        ...
        Map[
          Function[ch,
            ...
            <|
              ...
              "Regge all-in-ideal?" -> Lookup[regStudy, "All-in-ideal decomposition?", False],
      ...
      Function[{region, chRows},
        region <> ": " <> StringRiffle[
          Lookup[#, "Regge channel"] <> " -> Regge hidden=" <> Lookup[#, "Regge hidden?"] <>
            ...
            ", all-in-ideal=" <> ToString[Lookup[#, "Regge all-in-ideal?"]] & /@ chRows,
          " | "
        ]
      ],
      perRegion
