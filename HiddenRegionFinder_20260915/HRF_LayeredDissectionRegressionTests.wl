...
hrfRunLayeredDissectionRegressionTests[] := Module[
  ...
  AppendTo[rows, hrfLayeredTestRow[
    "DSC.UniformShift.AllSourceAwareAcceptedQ",
    DeleteDuplicates[accepted], {"AcceptedSourceAwareDissectedLowerFacet"}
  ]];
  AppendTo[rows, hrfLayeredTestRow[
  ...
  AppendTo[rows, hrfLayeredTestRow[
    "DSC.LegacyDissectionSkippedAfterSourceAwareCertificateQ",
    audits[[1, "LayeredDissectionCertification", "CertificationStatus"]],
    "SkippedSourceAwareDissectionCertified"
  ]];
  AppendTo[rows, hrfLayeredTestRow[
    "DSC.IdealLayerDissectionAgreementQ",
    audits[[1, "IdealLayerDissectionAgreementQ"]], True
  ]];
  AppendTo[rows, hrfLayeredTestRow[
    "DSC.EtaLatticeStep",
  ...
  AppendTo[rows, hrfLayeredTestRow[
    "NMRKwz.HierarchyGap", nmrkAudit["HierarchyGap"], 4
  ]];
  AppendTo[rows, hrfLayeredTestRow[
    "NMRKwz.SourceAwareAcceptedQ",
    nmrkAudit["AuditStatus"],
    "AcceptedSourceAwareDissectedLowerFacet"
  ]];
  AppendTo[rows, hrfLayeredTestRow[
    "NMRKwz.FSLOnLeadingFacetQ",
    nmrkAudit["FSLOnLeadingFacetQ"], True
  ]];
  AppendTo[rows, hrfLayeredTestRow[
    "NMRKwz.SyntheticPromotionNotUsedForAcceptanceQ",
    nmrkAudit["SyntheticFSLPromotionUsedForAcceptanceQ"], False
  ]];
...
If[MemberQ[FileNameTake /@ $ScriptCommandLine,
    "HRF_LayeredDissectionRegressionTests.wl"],
