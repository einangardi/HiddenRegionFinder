...
hrfKinematicGeneratorPreset["Collinear5pt"] = <|
  ...
  "UseGeneratorCompletionQ" -> True,
  "DimensionfulKinVars" -> {s},
  ...
  DeleteCases[
    {
      ...
      "UseGeneratorCompletionQ" -> Lookup[p, "UseGeneratorCompletionQ", Automatic],
      "DimensionfulKinVars" -> Lookup[p, "DimensionfulKinVars", Automatic]
    },
    _[_, Automatic]
  ]
];
