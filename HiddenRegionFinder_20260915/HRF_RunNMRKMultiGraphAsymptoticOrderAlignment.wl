...
compactRow[row_] := Module[{audit, hrf},
  ...
  <|
    ...
    "FSLOnLeadingFacetQ" -> Lookup[audit, "FSLOnLeadingFacetQ", Missing["NotAvailable"]],
    "ResolvedFSLWeight" -> Lookup[audit, "ResolvedFSLWeight", Missing["NotAvailable"]],
    "FSLSubleadingAfterCancellationQ" ->
      Lookup[audit, "FSLSubleadingAfterCancellationQ", Missing["NotAvailable"]],
    "SourceAwareCertifiedRegionCount" ->
      Lookup[audit, "SourceAwareCertifiedRegionCount", 0],
    "SyntheticFSLPromotionUsedForAcceptanceQ" ->
      Lookup[audit, "SyntheticFSLPromotionUsedForAcceptanceQ", False]
  |>
];
