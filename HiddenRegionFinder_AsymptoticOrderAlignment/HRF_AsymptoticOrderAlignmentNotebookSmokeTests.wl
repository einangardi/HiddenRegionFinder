...
hrfAsymptoticOrderAlignmentNotebookSmokeTests[] := Module[
  ...
  rows = {
    ...
    {"NMRK.GeneratorMultiplicityQualifiedQ",
      And[StringContainsQ[nmrkText, "five generator classes"],
        StringContainsQ[nmrkText,
    ...
    {"NMRK.PlanarCertified",
      nmrkTwoLoop["planar-hexbox", "CertifiedUniqueCount"], 11},
    {"NMRK.PlanarFullSupport",
      nmrkTwoLoop["planar-hexbox", "FullSupportCertifiedCount"], 7},
