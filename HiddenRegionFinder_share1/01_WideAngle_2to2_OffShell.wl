...
If[! ValueQ[$HRFRunHyperCrownInteriorScan], $HRFRunHyperCrownInteriorScan = True];
...
If[! ValueQ[findObstructions], Get[$HRFExample01Directory <> "HiddenRegionFinder.wl"]];
...
If[TrueQ[$HRFRunHyperCrownInteriorScan],
  ...
  HyperCrownInteriorScan = findObstructions[
    F0HyperCrown, VarsHyperCrown, KinAssump4ptOnShell, KinVars4pt, 30,
    "GeneratorMode" -> "PairSectors",
    "UseExtendedFactors" -> True,
    "MaxGenerators" -> 2
  ];,
...
If[TrueQ[$HRFRunHyperCrownBoundaryScansOnLoad],
  ...
  HyperCrownBoundaryCandidateScans = Table[
    Module[{zeroHC, f, vars, scan, genCheck, uRestricted},
      zeroHC = HyperCrownBoundaryZeroSets[[i]];
      f = Factor[Expand[F0HyperCrown /. Thread[zeroHC -> 0]]];
      vars = Complement[VarsHyperCrown, zeroHC];
      ...
      scan = If[vars === {} || f === 0,
        ...
        findObstructions[
          f, vars, KinAssump4ptOnShell, KinVars4pt, 30,
          "GeneratorMode" -> "PairSectors",
          "UseExtendedFactors" -> True,
          "MaxGenerators" -> 2
        ]
...
DBInteriorScan = findObstructions[
