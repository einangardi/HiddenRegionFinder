...
ClearAll[
  ...
  hrfReggeKinAssumptions, hrfReggeDeltaPolynomial, hrfReggeDeltaLayers,
  hrfReggeSubstituteBack, hrfReggeChannelData
];
...
(* Full Regge expansion polynomial in the auxiliary parameter delta.  The
   leading piece at delta^0 agrees with hrfReggeLeadingF. *)
hrfReggeDeltaPolynomial[F_, channel_String] := Module[{f = Expand[F]},
  Switch[channel,
    "T23", Expand[f /. s23 -> -\[Delta] s12],
    "T12", Expand[f /. s12 -> -\[Delta] s23],
    "T13", Expand[f /. s23 -> -s12 + \[Delta] s12],
    _, Missing["UnknownReggeChannel", channel]
  ]
];

hrfReggeDeltaLayers[F_, channel_String] :=
  hrfDeltaLayerAssociation[hrfReggeDeltaPolynomial[F, channel], \[Delta]];
