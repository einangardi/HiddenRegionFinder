...
hrfWideAngleBoundaryImplementedTests[] := Dataset[{
  ...
  <|"Test" -> "Kin-free sector generators (wide-angle Crown form)", "EnforcedInFinderQ" -> False,
    "Stage" -> "diagnostic", "Function" -> "hrfWideAngleKinSectorPresentationQ (subset)"|>,
  <|"Test" -> "F_SL = s_a g_a with quotients +/- s12,s23", "EnforcedInFinderQ" -> False,
    "Stage" -> "diagnostic", "Function" -> "hrfWideAngleKinSectorPresentationQ"|>,
