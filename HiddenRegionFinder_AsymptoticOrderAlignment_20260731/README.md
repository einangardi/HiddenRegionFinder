...
| Five-point central-soft MRK | `08_Current_5pt_MRK_CentralSoft.nb` | A composite MRK limit on the same seed topology; one full-layer-certified HR occurs for exactly the six attachments with the central gluon on a four-valent vertex. Parameter- and momentum-space power counting agree: `delta^(4 D-20)` |
...
momentum becomes soft.  The full native-layer audit finds one certified HR
...
recorded in `RELEASE_CHECKS_20260731.md`.
