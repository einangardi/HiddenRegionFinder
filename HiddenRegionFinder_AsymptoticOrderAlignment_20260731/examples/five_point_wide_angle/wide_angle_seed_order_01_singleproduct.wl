...
<|"Data" -> <|"ExternalOrderAtVertices" -> {1, 2, 3, 4, 5}, 
   ...
   "Variables" -> {x0, x1, x2, x3, x4, x5}|>, "Mode" -> "SingleProduct", 
 "Scan" -> <|"CancellationFactors" -> {s23*x3*x4 + s34*x2*x5 + s15*x3*x5, 
   ...
   "PolynomialFactorHarvestAudit" -> <|"Mode" -> "Polynomial", 
     "RawCount" -> 6, "EffectiveMaxMonomials" -> 3, "AcceptedCount" -> 6, 
     "PreNormalizeAcceptedCount" -> 6, "RejectedCount" -> 0, 
     "AuditRows" -> {<|"Factor" -> s23*x3*x4 + s34*x2*x5 + s15*x3*x5, 
