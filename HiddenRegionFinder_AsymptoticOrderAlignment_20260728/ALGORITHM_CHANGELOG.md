...
The current exact-coverage regression includes the SuperCrown boundary
`x8=x9=0` as a positive codimension-two control and the HyperCrown
opposite-pair orbit as a complete negative control.  The HyperCrown interior
remains unresolved; this status is deliberately distinct from the certified
opposite-pair exclusion.
