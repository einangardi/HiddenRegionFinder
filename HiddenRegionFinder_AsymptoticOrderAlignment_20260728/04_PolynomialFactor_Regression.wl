...
ClearAll[
  ...
  hrfEx04CrownRegression, hrfEx04SuperCrownInterior,
  hrfEx04SuperCrownX89Boundary, hrfEx04HyperCrownInterior,
...
(* Focused constructive witness for the Crown-inherited codimension-two
   boundary.  This is deliberately not a scan over all SuperCrown strata. *)
hrfEx04SuperCrownX89Boundary[] := Module[{case},
  hrfEx04LoadExample01[];
  case = Block[
    {$HRFEx04LightweightCaseQ = True,
     $HRFPolynomialEnableSignedMonomialPairs = False},
    hrfEx04RunObstructionCase[
      F0SuperCrown, VarsSuperCrown, KinAssump4ptOnShell, KinVars4pt,
      "SuperCrown boundary {x8,x9}=0", Automatic, {x8, x9},
      Expand[SuperCrownData["UF"]["U"] /. {x8 -> 0, x9 -> 0}],
      "WideAngle4ptBoundary"
    ]
  ];
  hrfEx04StoreCase[Ex04SuperCrownX89Target, case]
];
